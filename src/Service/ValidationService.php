...
class ValidationService
{
    ...
    public function formValidationUser(array $user): void
    {
        if (empty($user['user_name'])) {
            $this->errors[] = "Tu veux touché ou être touché et recevoir ton touch\'cadeau? Il faut ton nom";
        }
        ...
        if (empty($user['pseudo'])) {
            $this->errors[] = "Tu veux touché ou être touché et recevoir ton touch\'cadeau? Il faut ton pseudo";
        }
    ...
    public function formValidationUser2(array $user): void
    {
        if (empty($user['adress'])) {
            $this->errors[] = "On ne pourra pas te touché si on ne sait pas où tu habites";
        }
        if (empty($user['city'])) {
            $this->errors[] = "On ne pourra pas te touché si on ne sait pas où tu habites";
        }
